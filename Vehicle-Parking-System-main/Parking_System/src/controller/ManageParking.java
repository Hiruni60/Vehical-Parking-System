...
public class ManageParking implements CrudDAO<Parking,String> {

    ArrayList<Parking> parkingArrayList = new ArrayList<>(13);

    ArrayList<Parking> vanParkingSlots = new ArrayList<>(5);

    private static ManageParking manageParking;

    private ManageParking() throws Exception {
        getAll();
    }

    public static ManageParking getInstance() throws Exception{
        if (manageParking==null){
